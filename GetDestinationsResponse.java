...
public class GetDestinationsResponse {
    ...
    private java.util.List<com.travel.webservice.data.Destination_type> result;

    public java.util.List<com.travel.webservice.data.Destination_type> getResult() {
        return this.result;
    }

    public void setResult(java.util.List<com.travel.webservice.data.Destination_type> newResult)  {
