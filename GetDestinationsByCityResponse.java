...
public class GetDestinationsByCityResponse {
    ...
    private java.util.List<com.travel.webservice.data.Destination> result;

    public java.util.List<com.travel.webservice.data.Destination> getResult() {
        return this.result;
    }

    public void setResult(java.util.List<com.travel.webservice.data.Destination> newResult)  {
